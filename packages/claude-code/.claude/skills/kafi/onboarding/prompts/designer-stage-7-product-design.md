...
Write to aidlc-docs/inception/product-design/. Produce FOUR outputs in order (v0.7):
  ...
  2. **`uiux-spec.md`** (use templates/uiux-spec.md) — master narrative: sitemap, navigation chrome, screen catalog, cross-screen flows, key UX decisions, accessibility posture, story → screen coverage matrix.
