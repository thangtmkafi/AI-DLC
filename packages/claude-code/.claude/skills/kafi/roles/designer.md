...
- **Produce hi-fi screens as self-contained HTML mockups** using the design-system skill. Write them to `aidlc-docs/inception/product-design/mockups/`. These are the **FE source of truth for Code Generation** — Stage 14 reproduces them screen-by-screen — not throwaway reference images.
