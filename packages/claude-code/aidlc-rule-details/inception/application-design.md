...
1. **Domain modeling + author `data-model.md`** — entities, value objects, aggregates. Use `templates/02-inception-design/architecture/data-model.md`. Each entity gets an ENT-NN ID. Stage 7 view-model.md and Stage 10 domain-entities.md derive from this — keep entity names + types stable once locked.
...
| **`data-model.md`** | **System-wide data model** (NEW v0.7) · entities ENT-NN · attributes · relationships · invariants · schemas · classifications (PII / audit) · use `templates/02-inception-design/architecture/data-model.md` |
