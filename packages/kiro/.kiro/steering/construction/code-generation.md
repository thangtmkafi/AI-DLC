---
inclusion: manual
description: "Stage 14: Code Generation"
---
...
- **Use the exact design tokens** (colors, spacing, typography) from the mockup / design system — no ad-hoc styling, no invented colors.
