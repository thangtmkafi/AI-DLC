---
name: kafi-role-ba
description: Skill for Business Analyst working through KAFI AI-DLC. Defines BA responsibilities, dos, don'ts. Load when driving Stage 4 (Requirements), Stage 5 (User Stories), Stage 10 (Functional Design), or Pre-Inception sub-flows.
inclusion: manual
---
