...
1. **Domain modeling + author `data-model.md`** — entities, value objects, aggregates. Use `templates/data-model.md`. Each entity gets an ENT-NN ID. Stage 7 view-model.md and Stage 10 domain-entities.md derive from this — keep entity names + types stable once locked.
...
| **`data-model.md`** | **System-wide data model** (NEW v0.7) · entities ENT-NN · attributes · relationships · invariants · schemas · classifications (PII / audit) · use `templates/data-model.md` |
